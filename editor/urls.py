...
from .views import AddQuestionView, QuestionListView, DeleteQuestionView, QuestionView, EditQuestionView
...
urlpatterns = patterns('',
    ...
    url(r'^edit/(?P<pk>[\w]+)/$', EditQuestionView.as_view(), name='edit_question'),
